...
const inputColorRange = document.querySelector("[data-js='input-color']");
const inputRadiusRange = document.querySelector("[data-js='input-radius']");
const inputRotationRange = document.querySelector("[data-js='input-rotation']");
const box = document.querySelector("[data-js='box']");

inputColorRange.addEventListener("input", () => {
    const colorValue = inputColorRange.value; 
    box.style.backgroundColor = `hsl(${colorValue}, 100%, 50%)`; 
});

inputRadiusRange.addEventListener("input", () => {
    const rangeValue = inputRadiusRange.value; 
