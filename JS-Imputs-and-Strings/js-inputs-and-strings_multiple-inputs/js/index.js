...
copyButton.addEventListener("click", () => {
  const temp = firstCopyInput.value;
  secondCopyInput.value = temp;
});
...
copyInUppercaseButton.addEventListener("click", () => {
  const changeInUppercase = firstCopyInUppercaseInput.value.toUpperCase();
  secondCopyInUppercaseInput.value = changeInUppercase;
});
// --^-- write your code here --^--
